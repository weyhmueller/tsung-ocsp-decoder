...
-record('OCSPRequest',{
tbsRequest, optionalSignature = asn1_NOVALUE}).

-record('TBSRequest',{
version = asn1_DEFAULT, requestorName = asn1_NOVALUE, requestList, requestExtensions = asn1_NOVALUE}).

-record('Signature',{
signatureAlgorithm, signature, certs = asn1_NOVALUE}).

-record('Request',{
reqCert, singleRequestExtensions = asn1_NOVALUE}).

-record('CertID',{
hashAlgorithm, issuerNameHash, issuerKeyHash, serialNumber}).

-record('OCSPResponse',{
responseStatus, responseBytes = asn1_NOVALUE}).

-record('ResponseBytes',{
responseType, response}).

-record('BasicOCSPResponse',{
tbsResponseData, signatureAlgorithm, signature, certs = asn1_NOVALUE}).

-record('ResponseData',{
version = asn1_DEFAULT, responderID, producedAt, responses, responseExtensions = asn1_NOVALUE}).

-record('SingleResponse',{
certID, certStatus, thisUpdate, nextUpdate = asn1_NOVALUE, singleExtensions = asn1_NOVALUE}).

-record('RevokedInfo',{
revocationTime, revocationReason = asn1_NOVALUE}).
